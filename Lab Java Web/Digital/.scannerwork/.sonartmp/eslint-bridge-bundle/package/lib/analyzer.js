...
function analyzeJavaScript(input) {
    return analyze(input, input.filePath.endsWith('.vue') ? parser_1.parseJavaScriptVueSourceFile : parser_1.parseJavaScriptSourceFile);
}
exports.analyzeJavaScript = analyzeJavaScript;
function analyzeTypeScript(input) {
    return analyze(input, input.filePath.endsWith('.vue') ? parser_1.parseTypeScriptVueSourceFile : parser_1.parseTypeScriptSourceFile);
}
