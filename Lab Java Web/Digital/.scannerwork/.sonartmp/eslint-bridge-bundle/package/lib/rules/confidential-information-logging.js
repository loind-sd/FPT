        ...
        return {
            NewExpression: (node) => {
                ...
                if (secrets &&
                    ...
                    context.report({ node: callee, message: locations_1.toEncodedMessage(MESSAGE, [secrets]) });
                }
                else if (!secrets) {
                    context.report({ node: callee, message: locations_1.toEncodedMessage(MESSAGE, [firstArgument]) });
                }
            },
        };
    },
