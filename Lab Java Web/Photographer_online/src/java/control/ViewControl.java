...
public class ViewControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Gallery gallery = dao.getGalleryByID(id);
        List<Gallery> listGallery = dao.getTop3Gallery();
        List<String> listImage = dao.getAllImageByID(id);
        
        request.setAttribute("list", listGallery);
        request.setAttribute("listImg", listImage);
        request.setAttribute("g", gallery);
