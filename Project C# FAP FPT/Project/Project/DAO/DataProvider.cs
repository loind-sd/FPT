...
namespace Access
{
    class DataProvider
    {
        ...
        private readonly String connectionString = ConfigurationManager.ConnectionStrings["Project"].ToString();
        ...
        public int ExecuteScalar(string query,params object[] parameter)
        {
            int data = 0;
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
