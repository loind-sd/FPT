...
insert into ACCOUNT values ('1','nhung', '123456', 1)
insert into ACCOUNT values ('2','phuong', '123456', 1)
insert into ACCOUNT values ('3','truyen', '123456', 1)
insert into ACCOUNT values ('7','nha', '123456', 1)
insert into ACCOUNT values ('999','admin', '', 0)
---- select * from docgia


insert into DOCGIA values ('1','nhung',N'Nguyễn Thị Hồng Nhung','Nữ',2000,N'Hà Nội')
insert into DOCGIA values ('2','phuong',N'Hoàng Thu Phương','Nữ',2000,N'Hà Nội')
insert into DOCGIA values ('3','truyen',N'Tạ Thị Truyền','Nữ',2000,N'Bắc Giang')
insert into DOCGIA values ('7','nha',N'Kiều Tuấn Nhạ',N'Nam',2000,N'Vĩnh Phúc')


----
insert into SACH values ('1', N'Lập trình hướng đối tượng', N'Nguyễn Văn A', N'Lập trình', 'GD', 1500, 3, N'Còn')
insert into SACH values ('2', N'Nhập môn lập trình', N'Trần Văn B', N'Lập trình', 'GD', 1500, 10, N'Còn')
insert into SACH values ('3', N'Kỹ Thuật Lập Trình', N'Nguyễn Thị C', N'Lập trình', 'GD', 3000, 5, N'Còn')
insert into SACH values ('4', N'Thiết Kế Phần Mềm', N'Đỗ Văn D', N'Lập trình', 'GD', 4000, 0, N'Hết')
---
