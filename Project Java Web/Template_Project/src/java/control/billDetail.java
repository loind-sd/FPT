...
public class billDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<BillDetail> list = dao.getBillDetailByBid(id);
        for (BillDetail o : list) {
            all += Integer.parseInt(o.getSubTotal().replaceAll(",", ""));
        }
        request.setAttribute("listBillDetail", list);
        request.setAttribute("all", df.format(all));
